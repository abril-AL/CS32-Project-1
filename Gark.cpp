#include "Mesa.h" //does it need ? Yes uses Mesa methods
#include "Gark.h"
#include "globals.h" //for ioostream and std
...
{
    int a = m_row, b = m_col;
    // temp ints to hold old location bc record is called later
    m_health--;
    if (m_health == 0)
        return true;
